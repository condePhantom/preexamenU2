...
public class EJBOperacionesPrueba {
        ...
        if (u != null) {
            ...
            if (u.getPassword().equals(password)) {
                if (u.getActivo()) {
                    ...
                    m.setMessage("Usuario inactivo");
                }

            } else {
                m.setCode(HttpServletResponse.SC_EXPECTATION_FAILED); //417
                m.setMessage("Usuario o contraseña Incorrecto");
            }
        } else {
            m.setCode(HttpServletResponse.SC_NOT_FOUND); //404
    ...
    public String createUsuario(String nombre, String email, String password) {
        ...
        try {
            ...
            m.setCode(HttpServletResponse.SC_BAD_REQUEST); //502
